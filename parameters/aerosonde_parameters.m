...
MAV.ee = Euler2Quaternion(MAV.phi0, MAV.theta0, MAV.psi0);
MAV.e0     = MAV.ee(1);  % initial quaternion
MAV.e1     = MAV.ee(2);
MAV.e2     = MAV.ee(3);
MAV.e3     = MAV.ee(4);
...
% *******************GAMMA PARAMETERS FROM UAV BOOK PAGE 36******************
...
MAV.S_wing        = 0.55;   % Area
MAV.b             = 2.90;   % Wingspan
MAV.c             = 0.19;   % Chord
MAV.S_prop        = 0.2027;
MAV.rho           = 1.2682;
MAV.k_motor       = 80;
MAV.k_T_P         = 0;     % No torque
MAV.k_Omega       = 0;     % No torque
MAV.e             = 0.9;
...
%--------
MAV.C_m_0         = 0.0135;
MAV.C_m_alpha     = -2.71;           % Longitudinal static stability derivative
MAV.C_m_q         = -38.2;           % Pitch damping derivative
MAV.C_m_delta_e   = -0.99;           % Primary control derivative
%--------
MAV.C_Y_0         = 0.0;             % For symmetric aircraft
MAV.C_Y_beta      = -0.83;
MAV.C_Y_p         = 0.0;
MAV.C_Y_r         = 0.0;
...
%--------
MAV.C_ell_0       = 0.0;             % For symmetric aircraft
MAV.C_ell_beta    = -0.13;           % Roll static stability derivative  -0.13
MAV.C_ell_p       = -0.51;           % Roll damping derivative           -0.51
MAV.C_ell_r       = 0.045;
MAV.C_ell_delta_a = 0.17;            % Primary control derivative
MAV.C_ell_delta_r = 0.0024;          % Cross-control derivative
%--------
MAV.C_n_0         = 0.0;             % For symmetric aircraft
MAV.C_n_beta      = 0.073;           % Yaw static stability derivative   0.073
MAV.C_n_p         = -0.069;
MAV.C_n_r         = -0.155;          % Yaw damping derivative            -0.095
MAV.C_n_delta_a   = -0.011;          % Cross-control derivative
MAV.C_n_delta_r   = -0.069;          % Primary control derivative
MAV.C_prop        = 1.0;
